...
syn keyword nagiosDirective contained friday high_flap_threshold host_name host
...
syn keyword nagiosDirective contained host_notification_period hostgroup_name servicegroup_name hostgroups servicegroups service_groups hosts
